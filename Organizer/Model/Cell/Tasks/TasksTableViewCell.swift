...
class TasksTableViewCell: UITableViewCell {
    ...
    let taskName = UILabel(text: "Programm", font: .avenirNextDemiBold20())
    let taskDescription = UILabel(text: "Stsdy right code", font: .avenirNext14())
    ...
    func configure(model: TasksModel) {
        ...
        taskDescription.text = model.taskDesctiption
